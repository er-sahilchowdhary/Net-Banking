    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <table class="table table-striped" style="width:100%";>
		   ...
		   <tr> <th></th><td><img src="<?php echo $user_image; ?>" style="width:200px"/></td></tr>
		   <td><a href="update-user-profile.php?user_id=<?php echo $user_id; ?>" class="btn btn-sm btn-warning shadow-sm"> Edit Your Profile </a>
				</td>
			<tr> <th>User Id</th> <td><?php echo $user_id; ?></td> </tr>
			<tr> <th>Account Number</th> <td><?php echo $account_id; ?></td> </tr>
			<tr> <th>User Name</th> <td><?php echo $user_name; ?></td> </tr>
			<tr> <th>Email</th> <td><?php echo $email; ?></td> </tr>
			<tr> <th>Street</th> <td><?php echo $street; ?></td> </tr>
			<tr> <th>City</th>   <td><?php echo $city; ?></td> </tr>
			<tr> <th>State</th>  <td><?php echo $state; ?></td> </tr>
			<tr> <th>Pin Code</th> <td><?php echo $pincode; ?></td> </tr>
			<tr> <th>Phone no.</th> <td><?php echo $phone; ?></td> </tr>
			<?php } ?>
